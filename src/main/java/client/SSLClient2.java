...
public class SSLClient2 {
    ...
    public SSLClient2(String host, int porta) {
        this.host = host;
        this.porta = porta;
    }
    ...
    public void executa() {
        try {
            ...
            InputStream inputStream = ClassLoader.getSystemClassLoader().getResourceAsStream("client/certificate-client2.p12");
            ...
            InputStream inputStream1 = ClassLoader.getSystemClassLoader().getResourceAsStream("server/certificate-server2.p12");
    ...
    public static void main(String[] args) {
        new SSLClient2("localhost", 54321).executa();
    }
}
